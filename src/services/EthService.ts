...
export class EthService {
  ...
  static async sendTransaction(privateKey: string, toAddress: string, amountEth: string): Promise<{success: boolean; hash?: string; error?: string}> {
    try {
      ...
      return { success: false, error: e.reason || e.message || 'Transaction failed' };
    }
  }
