...
export function WalletsSheet({ visible, onClose }: Props) {
  ...
  const handleNameSubmit = () => {
    ...
    Keyboard.dismiss();
    const routeParams = {
      pathname: action === "create" ? "/seed-reveal-intro" : "/import-wallet",
      params: { name: walletName.trim() },
    };
    handleClose();
      ...
      >
        ...
        {step === "list" ? (
          ...
          <View>
            ...
            >
              Enter a name so you can easily identify this wallet later.
            </Text>

            <TextInput
              style={[
                styles.nameInput,
                error ? { borderColor: "#FE5353" } : null,
              ]}
            ...
            />
            {error ? (
              <Text style={{ color: "#FE5353", marginTop: 8 }}>{error}</Text>
            ) : null}
